...
from AutoCorrect.constants import regx

"""
---sample usage---

# where the text corpus is located
text_corpus_file_path = "../data/en_corpus.txt"

# where the frequency dictionary file is located
frequency_dict_file_path = "../data/sin_freq.json"
...
def load_corpus(corpus_file_path, lang):
    ...
    with open(corpus_file_path, 'r', encoding='utf-8') as file:
        for line in file:
            ...
            cleaned_words = [re.sub(regx[lang], '', word) for word in words]
...
def load_freq_dict_from_file(freq_dict_file_path, text_corpus_file_path,lang):
    ...
    if os.path.exists(freq_dict_file_path):
        ...
        frequency_dict = load_corpus(text_corpus_file_path, lang)
        ...
        # and save the corpus into the sin_freq.json
